...
printf "\n borrando imagen image-dm vieja si quedo como resabio de instalacion anterior\n\n"
...
gcloud compute instance-templates create temp-08vcpu-032ram         \
       ...
       --metadata-from-file shutdown-script=/home/$USER/install/shutdown-script.sh
...
gcloud compute instances  delete  desktop-jr   --zone=southamerica-west1-a \
...
# la detengo
gcloud compute instances  stop  desktop-jr   --zone=southamerica-west1-a
...
# la detengo
gcloud compute instances  stop  desktop-sr   --zone=southamerica-west1-a
...
/home/$USER/install/apagar-vm.sh
