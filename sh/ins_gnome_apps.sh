...
sudo  DEBIAN_FRONTEND=noninteractive  apt install  ./google-chrome-stable_current_amd64.deb
...
wget  $webfiles/desktop.dconf   -O  /home/$USER/.config/dconf/desktop.dconf
...
wget  https://github.com/raujonas/executor/archive/refs/tags/v26.zip  -O  /home/$USER/install/executor-26.zip
gnome-extensions install  /home/$USER/install/executor-26.zip
